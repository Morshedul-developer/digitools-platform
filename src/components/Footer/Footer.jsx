...
const Footer = () => {
  return (
    <footer className="bg-[#101727] pt-25 pb-10">
      <div className="footer sm:footer-horizontal  text-white max-w-7xl mx-auto mb-15 px-4 lg:px-0">
        <nav>
      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-0">
        ...
        <div className="text-gray-500 flex  flex-wrap gap-5 justify-center md:justify-between">
